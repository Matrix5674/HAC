        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Welcome to Hands Across Communities!
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Hands Across Communities is a nonprofit organization dedicated to providing seasonal necessities to individuals and families in need.
            </p>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-indigo-600">our sponsors</span>{" "}
            worldwide
          </div>

          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="pt-2 ml-20 text-gray-400 dark:text-gray-400">
              <HACLOGO />
            </div>
            {/*
...
function HACLOGO() {
  return (
    <svg
      ...
      height="52.39"
      fill="none"
      viewBox="0 0 253.5 52.39">
      <g clip-path="url(#clip0)">
        <path d="M50.7 26.195C50.7 26.195 50.7 16.9 25.35 16.9C0 16.9 0 26.195 0 26.195C0 26.195 0 35.49 25.35 35.49C50.7 35.49 50.7 26.195 50.7 26.195Z" fill="currentColor"/>
        <path d="M25.35 16.9C25.35 16.9 25.35 8.45 0 8.45C-25.35 8.45 -25.35 16.9 0 16.9C25.35 16.9 25.35 16.9 25.35 16.9Z" fill="currentColor"/>
        <path d="M25.35 35.49C25.35 35.49 25.35 43.94 0 43.94C-25.35 43.94 -25.35 35.49 0 35.49C25.35 35.49 25.35 35.49 25.35 35.49Z" fill="currentColor"/>
        <path d="M25.35 26.195C25.35 26.195 25.35 18.59 0 18.59C-25.35 18.59 -25.35 26.195 0 26.195C25.35 26.195 25.35 26.195 25.35 26.195Z" fill="currentColor"/>
        <text x="59.15" y="33.8" font-family="Arial" font-size="16.9" fill="currentColor">HACK CLUB</text>
      </g>
      <defs>
        <clipPath id="clip0">
          <path fill="currentColor" clip-rule="evenodd" d="M0 0h253.5v52.39H0z"/>
        </clipPath>
      </defs>
    </svg>
  );
